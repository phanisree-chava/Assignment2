...
<body>	
	...
	<h1 align="center"	style="font: normal; font-size: 30px; color: black;">All Products</h1>
	<c:choose>
		<c:when test="${products==null || products.isEmpty() }">
			<div align="center" style="font: normal; font-size: 20px; color: blue;">No products found. Add some products!!</div>
		</c:when>
		<c:otherwise>
			<div align="center">
