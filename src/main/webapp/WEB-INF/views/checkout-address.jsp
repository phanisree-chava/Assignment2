...
<body>
	...
	<ul class="nav nav-pills ">
		&nbsp;&nbsp;<li class="nav-item"><a class="btn btn-sm btn-info" href="${pageContext.request.contextPath}/user/home">Home</a></li>
		&nbsp;&nbsp;<li class="nav-item"><a class="btn btn-sm btn-info" href="${pageContext.request.contextPath}/user/show-kit">Show Kit</a></li>
		&nbsp;&nbsp;<li class="nav-item"><a class="btn btn-sm btn-info" href="${pageContext.request.contextPath}/user/show-list">Add Products</a></li>
	</ul>
	<div align="center">
	<h1 align="center" style="font: normal; font-size: 20px; color: black;">Provide Address</h1>
		<table>
			<tr>
				<td>
